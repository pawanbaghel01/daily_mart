...
class BrowsePage extends StatelessWidget {
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  _filterButton('Sort by', Colors.white),
                  _filterButton('Location',  Colors.white),
                  _filterButton('Category',  Colors.white),
                ],
              ),
            ),
          ),
  ...
  Widget _filterButton(String label, Color primaryColor) {
